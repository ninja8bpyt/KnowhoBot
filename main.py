...
def newbt(client,callback_query):
    ...
    if txt=="about":
        callback_query.message.edit(text=f"`Bot`            : [TRUEYE BOT](t.me/TRUEYE_BOT)\n`Creator :` [Ninja8bpYt](t.me/ninja8bpyt)\n`Channel:`@Bots_Ki_Duniya\n`Server  :` [Heroku](https://herokuapp.com/)",
...
def about(client, message):
    client.send_message(chat_id=message.chat.id, reply_to_message_id=message.message_id,
                        text=f"`Bot`            : [TRUEYE BOT](t.me/trueye_bot)\n`Creator :` [Ninja8bpyt](t.me/ninja8bpyt)\n`Channel:`@Bots_Ki_Duniya\n`Server  :` [Heroku](https://herokuapp.com/)",
                        disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Feedback", url="t.me/mr_ninjas_bot")]]))
